...
# Model paths
MODEL_PATHS = {
    "rl_round": project_root / "big_rl" / "rl_round" / "RL_data" / "rl_bank_model_ppo_troll.zip",
    "rl_score": project_root / "big_rl" / "rl_score" / "RL_data" / "rl_bank_model_ppo_multi.zip",
    "rl_sparse": project_root / "big_rl" / "rl_sparse" / "RL_data" / "rl_bank_model_ppo_troll.zip",
    "rl_sparse_better": project_root / "big_rl" / "rl_sparse_better" / "RL_data" / "rl_bank_model_ppo_troll.zip",
}
...
def main():
    ...
    print("=" * 80)
    print("PPO Agents Free-for-All Tournament (Troll)")
    print("=" * 80)
    ...
    save_path = output_dir / "ppo_agents_tournament_troll.png"
